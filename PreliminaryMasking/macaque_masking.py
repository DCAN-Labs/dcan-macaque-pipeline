...
def _cli():
    ...
    return interface(args.path, args.t1, args.t2, args.func, args.fmapmag,
...
def interface(path, t1w_images, t2w_images, functional_images, dfm_image,
              study_atlas_head, study_atlas_brain, verbose):
    cmdlist = []
